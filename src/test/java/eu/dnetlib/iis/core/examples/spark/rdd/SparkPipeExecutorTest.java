...
import eu.dnetlib.iis.core.examples.spark.rdd.SparkPipeExecutor;
...
public class SparkPipeExecutorTest {
    ...
    @Mock
    private JavaPairRDD<AvroKey<GenericRecord>, NullWritable> avroKeyValueRDD;

    @Mock
    private JavaRDD<AvroKey<GenericRecord>> avroRDD;

    @Mock
    private JavaRDD<String> mappedStringRDD;

    @Mock
    private JavaPairRDD<String, String> mappedKeyValueRDD;

    @Mock
    private JavaPairRDD<String, String> sortedKeyValueRDD;

    @Mock
    private JavaRDD<String> stringRDD;

    @Mock
    private JavaRDD<String> reducedStringRDD;

    @Mock
    private JavaRDD<Document> reducedAvroDocumentRDD;

    @Mock
    private JavaPairRDD<AvroKey<GenericRecord>, NullWritable> reducedAvroKeyValueRDD;
